...
/**
 * This class is a representation of a Oval. The dinmensions of an Rect are width and height..
 */
public class Rect extends TwoDShapeImpl {
  /**
   ...
   */
  public Rect(String name, ShapesAllow shapesType) {
   ...
   */
  public Rect(String name, Pos pos, Dim dim, Color color, ShapesAllow shapeType) {
   ...
   * @throws IllegalArgumentException Throws when not a Rect.
   */
  void verifyShape(ShapesAllow type) {
    if (!type.equals(ShapesAllow.Rect)) {
      throw new IllegalArgumentException("The shape being made is not Rectangle.");
    }
  }
}
